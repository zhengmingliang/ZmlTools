...
public class TieyouTest {
    ...
    public void loginTest() {
        String params =
                "{\"appVersion\":\"7.4.2\",\"clientId\":\"android\",\"partnerName\":\"tieyou\"," +
                        "\"userMobile\":\"18519094522\",\"channel\":\"ark_android_hicloud\"," +
                        "\"sign\":\"78e63b58d45f30e26868aaa44f925ab8\",\"clientInfo\":\"android|COL-AL10|8.1.0|7.4" +
                        ".2|706009|ark_android_hicloud|869384032241018|WIFI|32001059510031348080\"," +
                        "\"reqTime\":\"1539100795\",\"extendInfo\":{\"type\":0}," +
                        "\"deviceId\":\"161206928a7dee7d8d41cd9effbe5bb1aa9ca6\",\"token\":\"\"}";
...
//        System.out.println(stringBuffer.toString());
        ...
        jsonObject.put("sign",
                EncryptUtils.md5(String.format("%s%s", new Object[]{this.privateKey, str})).toLowerCase());
        System.out.println(jsonObject.toJSONString());
