...
public class DataUtilsTest {
    ...
    public void isWebUrl() {
        ...
        String json = "{\n" +
                ...
                "  \"iqiyi\": \"http://pan.iqiyi.com/file/sns_comment_v2/dzvo7Fz77eO8-VVbP2aDjCJb2" +
                "-HoZ05ZUtMuRNrM9AuRa0Pr31p6CZDCaPdIAC4iGXuC54U6iZNS7IHIfxddGg.jpg\",\n" +
                "  \"souhu\": \"https://cy-pic.kuaizhan" +
                ".com/g3/46/aa/9b3d-d8ec-472e-8642-dfa2325c353541?cysign=346004560ebec4ab1ce15ffdfb2d27fe&cyt" +
                "=1600496692\",\n" +
                "  \"fenghuang\": \"https://x0.ifengimg" +
                ".com/uploading/user/20200919142502/114936669/39a434b95111451ca5d4546316aea30a.jpg\",\n" +
                "  \"360快传\": \"http://p6.qhimg.com/t011be5862d2b578f8f.jpg\",\n" +
                "  \"csdn\": \"\",\n" +
                "  \"youku\": \"https://image.planet.youku" +
                ".com/img/100/19/62238" +
                "/i_1490875862238_463c5414e61cb8bb194e8da687d4defc_b_w1920h1200_face_w1920h1200_x962y293w189h281c1" +
                ".jpg\",\n" +
    ...
    public void getNullPropertyNames() {
        ...
        Assert.isTrue(
                ((JSONArray) JSON.toJSON(emptyPropertyNames)).containsAll(Arrays.asList("sex", "address", "friends")));
    }
    ...
    public void mapToBean() {
        ...
        params.put("sex", 1);
        params.put("friends",
                Arrays.asList(new JSONObject().fluentPut("name", "李四").fluentPut("age", 20).put("sex", true)));
