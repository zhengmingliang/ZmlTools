...
public class PortsUtils {
    ...
    public static void main(String[] args) {
        String ip = "net.alianga.com";
        String port =
                "1,3-4,6-7,9,13,17,19-26,30,32-33,37,42-43,49,53,70,79-85,88-90,99-100,106,109-111,113,119,125,135," +
                        "139,143-144,146,161,163,179,199,211-212,222,254-256,259,264,280,301,306,311,340,366,389," +
                        ...
                        "765,777,783,787,800-801,808,843,873,880,888,898,900-903,911-912,981,987,990,992-993,995," +
                        "999-1002,1007,1009-1011,1021-1100,1102,1104-1108,1110-1114,1117,1119,1121-1124,1126," +
        ...
        List<Integer> integers = scanPorts(ip, port);
        ...
        port = "10000-10100,21112,29100,35000-40000,";
        integers = scanPorts(ip, port);
